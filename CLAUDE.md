...
This project is indexed by GitNexus as **comonteur** (377 symbols, 566 relationships, 25 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
